						...
						<c:when test="${filtro == 'todos' || filtro == null}">
							<c:forEach var="usuario" items="${usuarios}">
								<tr>
									...
									<c:choose>
										<c:when
											test="${usuario.getClass().getName().equals('me.portafolio.inclusiveTrip.modelo.Administrativo')}">
										...
										<c:when
											test="${usuario.getClass().getName().equals('me.portafolio.inclusiveTrip.modelo.Cliente')}">
											<td></td>
											<td></td>
